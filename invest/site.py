    ...
    return {
        ...
        "pipeline": {
            "cadence": [
                ...
                {"kind": "postmarket", "when": "4:30 PM ET on NYSE trading days", "purpose": "Reuse stored broker positions while refreshing end-of-day price action, attribution, catalysts, and follow-up ticket state."},
            ...
            "steps": [
                ...
                {"key": "broker_sync", "label": "Private position sync", "source": "IBKR Flex premarket only plus optional manual sleeves"},
